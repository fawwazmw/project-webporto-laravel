        ...
        <div class="container">
            ...
            <div class="cs_project_slider_2 cs_gap_24">
                @if($projects->isEmpty())
                    ...
                    <div class="no-projects-message text-center">
                            ...
                            <div class="cs_slide">
                                <div class="cs_portfolio cs_style_1 position-relative overflow-hidden">
                                    ...
                                    <div class="cs_portfolio_thumb d-block h-100 w-100 background-filled cs_transition_6"
                                         data-src="{{ asset('storage/' . $project->image) }}"></div>
                                    <h3
                ...
                <div class="cs_slider_next filter cs_height_45 cs_width_45 bg-white rounded-circle d-flex align-items-center justify-content-center bg-accent-hover cs_transition_4 position-absolute">
                    <svg width="20" height="8" viewBox="0 0 20 8" fill="none"
                        ...
                        <path
                            ...
                            fill="#18191D"/>
                        <path
                            d="M16.3445 7.60253C16.2394 7.60253 16.1342 7.56278 16.0547 7.48202C15.8945 7.32176 15.8945 7.0615 16.0547 6.90125L19.2496 3.70637C19.4099 3.54612 19.6702 3.54612 19.8304 3.70637C19.9907 3.86663 19.9907 4.12689 19.8304 4.28714L16.6355 7.48202C16.5547 7.56278 16.4496 7.60253 16.3445 7.60253Z"
                            fill="#18191D"/>
                    </svg>
                </div>
            </div>
